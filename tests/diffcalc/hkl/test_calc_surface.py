...
def test_ub_with_willmot_si_5_5_12_mu_eta_fixed():
    ...
    ubcalc.add_reflection(
        (2, 19, 32),
        Position(-90, 21.975, 4.419, 0.0, 92.0, -416.2),
        19.5005033,
        "ref0",
    )
    ubcalc.add_reflection(
        (0, 7, 22),
        Position(-90, 11.292, 2.844, 0, 92, -214.1),
        19.5005033,
        "ref1",
    )
    ubcalc.calc_ub()
...
def test_ub_with_willmot_si_5_5_12_mu_chi_fixed():
    ...
    ubcalc.add_reflection(
        (2, 19, 32),
        Position(0.0, 21.975, 4.419, 2.0, 90.0, -326.2),
        19.5005033,
        "ref0",
    )
    ubcalc.add_reflection(
        (0, 7, 22),
        Position(0.0, 11.292, 2.844, 2.0, 90.0, -124.1),
        19.5005033,
        "ref1",
    )
    ubcalc.calc_ub()
...
def test_ub_with_willmot_pt531_mu_chi_fixed():
    ...
    ubcalc.add_reflection(
        (-1, 1, 6),
        Position(0.0, 9.397102500000003, 16.1812303, 2.0, 90.0, 52.1392905),
        19.5005033,
        "ref0",
    )
    ubcalc.add_reflection(
        (-2, -1, 7),
        Position(0.0, 11.012695800000001, -11.8636128, 2.0, 90.0, -40.3803393),
        19.5005033,
        "ref1",
    )
    ubcalc.calc_ub()
